...
import SubjectSidebarPublic from "../../../components/SubjectDetail/SubjectSidebar/SubjectSidebarPublic";

const SubjectDetailPublic = () => {
  ...
  try {
    useEffect(() => {
      fetch(`${api}/public?subjectId=${subjectId} `, {
        headers: {
    ...
    <div className="row subject-detail-page-wrap">
      ...
      <div className="col-md-3">
        <SubjectSidebarPublic
          ...
          lessonId={lessons && lessons.length > 0 ? lessons[0].lessonId : null}
        />
      </div>
    </div>
  );
...
export default SubjectDetailPublic;
