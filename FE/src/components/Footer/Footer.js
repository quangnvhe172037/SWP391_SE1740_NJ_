        ...
        <div className="mx-auto ">
          <section className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 lg:justify-items-center">
            ...
            <div>
              ...
              <h3 className="text-gray-500 mb-2 text-sm">Tax ID: 0109922901</h3>
              <h3 className="text-gray-500 mb-2 text-sm">
                Founded: 03/04/2022
              </h3>
              <h3 className="text-gray-500 mb-2 text-sm">
                Fields: Technology, Education, Programming. Quizzi builds and
                develops products that bring value to the community.
              </h3>
            </div>
          </section>
